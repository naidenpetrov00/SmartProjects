export const enPlaces = {
  places: {
    NedelchoApart: {
      title: 'Sofia',
      subtitle: 'Two-bedroom apartment, ideal center',
      description: `- Refreshing renovation
...
- supply and installation of a boiler, sanitary equipment, and radiators`,
    ...
    Gard: {
      ...
      description:
        'This is a beautifully renovated two-bedroom apartment in Sofia.',
    },
    Gost: {
      title: 'Gost Place',
      subtitle: 'Luxury Suite',
      description: 'Experience the elegance of our luxury suite at Gost Place.',
    },
    Gostinyata: {
      title: 'Gostinyata',
      subtitle: 'Spacious Living Room',
      description:
        'A spacious living room featuring modern design and cozy ambiance.',
    },
    Spa: {
      title: 'Spa Center',
      subtitle: 'Relaxation and Wellness',
      description:
        'Enjoy ultimate relaxation in our state-of-the-art spa facilities.',
    },
  },
};
